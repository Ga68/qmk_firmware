...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        UKC_ZOOM_LAYER, KC_1       , KC_2       , KC_3       , KC_4       , KC_5,                   KC_6, KC_7       , KC_8       , KC_9       , KC_0       , KC_CAPS_LOCK  ,
    ...
    [_NUM] = LAYOUT(
        ...
        __x__   , __x__  , __x__  , __x__    , __x__  , __x__,               __x__       , UKC_TH_4, UKC_TH_5, UKC_TH_6, KC_MINS , KC_PLUS,
        KC_ENTER, KC_LCTL, KC_LALT, KC_LSHIFT, KC_LGUI, __x__,               KC_EQL      , UKC_TH_1, UKC_TH_2, UKC_TH_3, UKC_TH_0, KC_DOT ,
